...
class EnvironmentalAdvancedCache {
    ...
    private function generate_cache_key() {
        ...
        if (isset($_GET['location'])) {
            $env_context .= '_loc_' . sanitize_text_field($_GET['location']);
        }
        if (isset($_GET['category'])) {
            $env_context .= '_cat_' . sanitize_text_field($_GET['category']);
        }
    ...
    private function log_cache_event($action, $file = null, $data = array()) {
        ...
        $log_file = WP_CONTENT_DIR . '/cache/environmental-cache.log';
